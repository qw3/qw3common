  ...
  module Generators
    class PaginationGenerator < Rails::Generators::Base
      ...
      def create_public_files
        #javascripts
        copy_file "assets/javascripts/pagination.js", "public/javascripts/qw3/pagination.js"
        #stylesheets
        copy_file "assets/stylesheets/pagination.css", "public/stylesheets/qw3/pagination.css"
      end
